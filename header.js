...
(function() {
  ...
  whenReady(function() {
    ...
    style.textContent = 
      // ========== FONTS ==========
      '@import url("https://fonts.googleapis.com/css2?family=Tajawal:wght@300;400;500;700;800&family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300&family=Playfair+Display:ital,wght@0,400;0,600;1,400&display=swap");' +
      
      // ========== DARK THEME (Défaut) ==========
      ':root{--gold:#C4A06A;--gold-light:#D4B896;--gold-dim:rgba(196,160,106,0.15);--bg:#1A1510;--text:#E8DDD0;--text-muted:#A89880}' +
      
      // ========== WHITE THEME ==========
      'body.white-theme{--gold:#A07840;--gold-light:#C4A06A;--gold-dim:rgba(160,120,64,0.12);--bg:#FDFCF8;--text:#2A2218;--text-muted:#6B5F52}' +
      
      // ========== NAV STYLES ==========
      '.almaya-nav{background:rgba(26,21,16,0.92);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border-bottom:1px solid rgba(196,160,106,0.15);position:sticky;top:0;z-index:999;font-family:"Tajawal",sans-serif;direction:rtl;transition:background 0.5s ease,border-color 0.5s ease}' +
      
      // White theme nav
      'body.white-theme .almaya-nav{background:rgba(253,252,248,0.92);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border-bottom:1px solid rgba(160,120,64,0.12)}' +
      'body.white-theme .almaya-nav.scrolled{background:rgba(253,252,248,0.98);box-shadow:0 4px 30px rgba(0,0,0,0.08)}' +
      ...
      // Brand - font élégante
      '.almaya-nav__brand{font-family:"Playfair Display","Cormorant Garamond",serif;font-size:1.15rem;font-weight:400;font-style:italic;color:var(--gold);letter-spacing:1.5px;white-space:nowrap;transition:color 0.5s ease}' +
      '.almaya-nav__brand span{font-family:"Tajawal",sans-serif;font-size:0.55rem;font-weight:300;letter-spacing:2px;color:var(--text-muted);display:block;margin-top:-2px}' +
      
      // Liens - font claire et lisible
      '.almaya-nav__links{display:flex;align-items:center;gap:2.2rem;list-style:none;margin:0;padding:0}' +
      '.almaya-nav__links a{font-family:"Tajawal",sans-serif;color:var(--gold-light);text-decoration:none;font-size:0.7rem;font-weight:500;letter-spacing:1.5px;text-transform:uppercase;position:relative;padding-bottom:3px;transition:color 0.3s}' +
      '.almaya-nav__links a::after{content:"";position:absolute;bottom:0;right:0;width:0;height:1.5px;background:var(--gold);transition:width 0.3s ease;border-radius:1px}' +
      ...
      '.almaya-nav__login-btn{padding:0.5rem 1.2rem !important;background:var(--gold);color:#1A1510 !important;border-radius:4px;font-weight:700 !important;letter-spacing:1px !important;transition:all 0.3s !important;font-family:"Tajawal",sans-serif !important}' +
      ...
      // White theme burger
      'body.white-theme .almaya-nav__burger{background:rgba(0,0,0,0.03);border:1px solid rgba(160,120,64,0.2)}' +
      'body.white-theme .almaya-nav__burger span{background:var(--gold)}' +
      ...
      'body.white-theme .almaya-nav__mobile{background:rgba(253,252,248,0.97)}' +
      
      '.almaya-nav__mobile.open{max-height:500px;opacity:1;border-top-color:rgba(196,160,106,0.1)}' +
      'body.white-theme .almaya-nav__mobile.open{border-top-color:rgba(160,120,64,0.1)}' +
      
      '.almaya-nav__mobile ul{list-style:none;margin:0;padding:0.5rem 1.5rem 1.25rem;display:flex;flex-direction:column}' +
      '.almaya-nav__mobile ul li a{display:block;padding:0.85rem 0;color:var(--gold-light);text-decoration:none;font-size:0.72rem;font-weight:500;letter-spacing:1.5px;text-transform:uppercase;border-bottom:1px solid rgba(196,160,106,0.07);transition:color 0.3s,padding-right 0.3s;font-family:"Tajawal",sans-serif}' +
      'body.white-theme .almaya-nav__mobile ul li a{border-bottom:1px solid rgba(160,120,64,0.07)}' +
      ...
      '.almaya-nav__mobile .mobile-login-btn{background:var(--gold) !important;color:#1A1510 !important;text-align:center !important;margin-top:0.5rem !important;border-radius:4px !important;font-weight:700 !important;padding:0.7rem 0 !important;border-bottom:none !important;font-family:"Tajawal",sans-serif !important}' +
      '.almaya-nav__mobile .mobile-login-btn:hover{background:#D4B896 !important;color:#1A1510 !important;padding-right:0 !important}' +
      ...
      '@media(max-width:480px){.almaya-nav__inner{padding:0.65rem 0.75rem}.almaya-nav__logo-img{height:36px}.almaya-nav__brand{font-size:0.9rem}.almaya-nav__burger{width:32px;height:32px;padding:5px 7px}.almaya-nav__burger span{width:16px}.almaya-nav__burger.open span:nth-child(1){transform:translateY(5.5px) rotate(45deg)}.almaya-nav__burger.open span:nth-child(3){transform:translateY(-5.5px) rotate(-45deg)}}';
  ...
  function initHeaderEvents() {
    // Active link - détecter la page courante
